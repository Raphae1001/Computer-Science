...
public int getUserId() {
    return user.id; // Assure-toi que l'attribut id existe dans la classe User
}

public int getExerciseId() {
    return exercise.id; // Assure-toi que l'attribut id existe dans la classe Exercise
}

public long getSubmissionTime() {
    return submissionTime.getTime(); // Convertit la date en millisecondes depuis l'époque Unix
}
}
